...
with tab3:
    ...
    if f_momento_bu_tab3 or f_hito_tab3 or f_paquete_tab3:
        ...
        with carga_personalizada("Aplicando filtros..."):
    ...
    st.download_button("⬇️ Descargar (CSV)", csv_completo, "fcs_vacios.csv", "text/csv")
